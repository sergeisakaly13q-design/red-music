...
function requireCsrfOrigin(req, res, next) {
  ...
  // Requests without Origin/Referer are allowed only when they do not carry
  // the browser authentication cookie. This preserves server-to-server and
  // CLI/API integrations while preventing cookie-based CSRF.
